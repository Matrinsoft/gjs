...
* Mon Aug 31 2026 Milan Crha <mcrha@redhat.com> - 1.89.90-1
- Update to 1.89.90

* Mon Aug 03 2026 Jan Grulich <jgrulich@redhat.com> - 1.89.2-1
- Update to 1.89.2

* Sun Aug 02 2026 František Zatloukal <fzatlouk@redhat.com> - 1.89.1-3
- Rebuild against mozjs140-140.13.0

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.89.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 29 2026 Milan Crha <mcrha@redhat.com> - 1.89.1-1
- Update to 1.89.1

* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.88.0-3
- Add configuration for release-monitoring

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 1.88.0-1
- Update to 1.88.0

* Tue Mar 03 2026 Jan Grulich <jgrulich@redhat.com> - 1.87.90-1
- Update to 1.87.90

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 1.87.2-6
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.87.2-5
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 1.87.2-4
- Onboard to Packit for stable Fedora branches

* Tue Feb 10 2026 Miro Hrončok <miro@hroncok.cz> - 1.87.2-3
- Rebuilt with mozj140 without the exported __aarch64_ldadd4_acq_rel symbol
- Fixes: rhbz#2391822

* Tue Feb 03 2026 Jan Horak <jhorak@redhat.com> - 1.87.2-1
- Update to 1.87.2

* Mon Jan 19 2026 Jan Horak <jhorak@redhat.com> - 1.87.1-1
- Update to 1.87.1

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.86.0-2
